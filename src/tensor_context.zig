...
pub fn TensorContext(comptime backend: Backend) type {
    return struct {
        ...
        pub fn opInPlace(_: Self, a: anytype, b: std.meta.Child(@TypeOf(a)), op_fn: fn_types.BinaryOpFn) TensorOpError!void {
            try backend.vtable.op(backend.ptr, a.*, b, a, op_fn);
        }

        pub fn opWithOut(_: Self, a: anytype, b: @TypeOf(a), out: *@TypeOf(a), op_fn: fn_types.BinaryOpFn) TensorOpError!void {
        ...
        pub fn mapInPlace(_: Self, a: anytype, map_fn: fn_types.MapFn) TensorOpError!void {
            try backend.vtable.map(backend.ptr, a.*, a, map_fn);
        }

        pub fn mapWithOut(_: Self, a: anytype, out: *@TypeOf(a), map_fn: fn_types.MapFn) TensorOpError!void {
        ...
        pub fn vectorNorm(_: Self, v: anytype) TensorOpError!@TypeOf(v).DataType {
            var result: @TypeOf(v).DataType = undefined;
            try backend.vtable.vectorNorm(backend.ptr, v, &result);
            return result;
        }

        pub fn matrixVectorMultiply(_: Self, m: anytype, v: anytype) TensorError!@TypeOf(v) {
        ...
        pub fn matrixVectorMultiplyWithOut(_: Self, m: anytype, v: anytype, out: *@TypeOf(v)) TensorOpError!void {
        ...
        fn elementwiseOpInPlace(op_fn: fn_types.BinaryOpFn) @TypeOf(exampleElementwiseOpInPlace) {
            return struct {
                fn opInPlaceFn(_: Self, a: anytype, b: std.meta.Child(@TypeOf(a))) TensorOpError!void {
                    try backend.vtable.op(backend.ptr, a.*, b, a, op_fn);
                }
            }.opInPlaceFn;
        }
